...
python src/inference_2.py --ckpt_dir "/media/gnort/HDD6/Study/face-analysis-lightning/logs/train/runs/2024-01-15_IR50_balanced_race_v1/checkpoints" \
                        --csv_path "outputs/answer_race_resnet_50_focal_3.csv" \
