...
from .components.face_dataset_leonard import FaceDataset_Leo


class FaceDataModule_Leo(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            self.data_train = FaceDataset_Leo(
